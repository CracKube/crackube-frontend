...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy">
      ...
      <h3>Last updated on 26-10-2023 21:17:24</h3>
      <p>
        This privacy policy (“Policy”) relates to the manner CRACKUBE PRIVATE
        LIMITED (“we”, “us”, “our”) in which we use, handle and process the data
        that you provide us in connection with using the products or services we
        offer. By using this website or by availing goods or services offered by
        us, you agree to the terms and conditions of this Policy, and consent to
        our use, storage, disclosure, and transfer of your information or data
      ...
      <p>
        CRACKUBE PRIVATE LIMITED may change this Policy periodically and we urge
        you to check this page for the latest version of the Policy in order to
      ...
      <p>
        ...
        applicable Indian laws, we will notNote be storing any credit card,
      ...
      <h2>What we do with the data we collect</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          including any special offers. To communicate information to you
        </li>
      ...
      <p>
        Right to Review data (to the extent feasible, as determined by us). That
        said, we will not be responsible for the authenticity of the data or
        information provided by you. - You can choose not to provide your data,
        at any time while availing ourWithdrawal of your Consent goods or
        services or otherwise withdraw your consent provided to us earlier, in
        writing to our email ID: support@crackube.comIn the event you choose to
        not provide or later withdraw your consent, we may not be able to
        provide you our services or goods.Please note that these rights are
