...
function Login() {
  ...
  const handleEmail = (e) => {
    ...
    const mailCheck =
      /[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[a-z]{2,8}(.[a-z{2,8}])?/.test(value);
    setChecks({
      mailCheck,
    });
  };
  ...
  const handleSignUP = async () => {
    ...
    const response = await fetch(
      "https://crackube-backend-test.onrender.com/auth/createUser",
      {
        ...
        body: `email=${document.getElementById("email1").value}&password=${
      ...
      <div className="out">
        ...
        <div className="main">
          <div className="box title">
            <p>
              Create a Account<span className="dot">.</span>
            </p>
          </div>
          <div className="box">
            <p>
              Already have an account?{" "}
              <a href="/signup" className="log">
                Log in
              </a>
            </p>
          </div>
          ...
          <div className="info">
            <h5>
              By Signing Up, you agree to <a href="">terms of use</a> and
              <br></br> <a href=""> privacy statements.</a>
            </h5>
          </div>
