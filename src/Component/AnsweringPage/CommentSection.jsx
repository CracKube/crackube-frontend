...
const CommentSection = ({openComment, setCommentId, id}) => {
  ...
  const postComments = async () => {
    let value;
    value =  `commentBody=${commentBody}&userCommented=${window.localStorage.getItem("userId")}`
    ...
    <div className="comment-cover">
        ...
        <div className='comment-flex'>
            ...
            <div className='send-msg'>
                <input type="text"  placeholder='Add a comment, @ to mention' onChange={(e) => {handleComments(e)}} />
            </div>
